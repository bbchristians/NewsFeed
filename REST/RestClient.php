...
if (isset($_GET["action"]) && isset($_GET["id"]) && $_GET["action"] == "get_person") 
{
  ...
  //$person_info = file_get_contents('http://www.se.rit.edu/~bbc7909/REST/RESTAPI.php?action=get_person&id=' . $_GET["id"]);
  $person_info = file_get_contents('http://www.se.rit.edu/~rl5849/REST/RESTAPI.php?action=get_person&id=' . $_GET["id"]);
  ...
  ?>
    ...
    <!--<a href="http://www.se.rit.edu/~bbc7909/REST/RestClient.php?action=get_person_list" alt="person list">Return to the person list</a>-->
    <a href="http://www.se.rit.edu/~rl5849/REST/RestClient.php?action=get_person_list" alt="person list">Return to the person list</a>
  <?php
}
else // else take the person list
{
  ...
  //$person_list = file_get_contents('http://www.se.rit.edu/~bbc7909/REST/RESTAPI.php?action=get_person_list');
  $person_list = file_get_contents('http://www.se.rit.edu/~rl5849/REST/RESTAPI.php?action=get_person_list');
  ...
  ?>
    ...
    <?php foreach ($person_list as $person): ?>
      <li>
        ...
        <!--<a href=<?php //echo "http://www.se.rit.edu/~bbc7909/REST/RestClient.php?action=get_person&id=" . $person["id"]  ?> alt=<?php echo "person_" . $person_["id"] ?>><?php echo $person["name"] ?></a>-->
        <a href=<?php echo "http://www.se.rit.edu/~rl5849/REST/RestClient.php?action=get_person&id=" . $person["id"]  ?> alt=<?php echo "person_" . $person_["id"] ?>><?php echo $person["name"] ?></a>
    </li>
    <?php endforeach; ?>
    </ul>
  <?php
